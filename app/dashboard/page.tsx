  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-[100dvh] w-full relative overflow-hidden font-sans bg-[#050505] p-6 lg:p-0">
      ...
      <header className="absolute top-0 left-0 w-full p-6 lg:px-12 lg:py-8 flex justify-between items-center z-50">
        ...
        {/* Poznamka: Uživatelský avatar (UserButton) je automaticky injektován globálním layoutem vpravo nahoře */}
      </header>

      {/* BACKGROUND GRADIENTS & 3D GLOW */}
      ...
      <div className="relative z-10 flex flex-col items-center text-center w-full max-w-5xl mt-16">
        ...
        <div className="w-full max-w-4xl flex flex-col gap-4 lg:gap-6 mt-16 lg:mt-24 relative z-10 px-4 lg:px-0">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            {/* MODULE 1: FOREX */}
            <div className="p-6 lg:p-8 bg-black/40 border border-white/5 rounded-xl flex flex-col text-left h-full backdrop-blur-sm shadow-inner">
          ...
          {/* MODULE 3: LABORATORY */}
          <div className="p-6 lg:p-8 bg-black/40 border border-white/5 rounded-xl flex flex-col md:flex-row justify-between items-start md:items-center gap-6 text-left backdrop-blur-sm shadow-inner">
