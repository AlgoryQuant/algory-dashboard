...
import { Calendar, Crosshair, TrendingUp, Shield, Activity, AlertTriangle } from 'lucide-react';
...
export default function MasterPlanQ4() {
  ...
  // Custom Tooltip pro minimalistický vzhled
                ...
                >
                  {ALLOCATION_DATA.map((entry, index) => (
                    <Cell 
                      key={`cell-${index}`} 
                      fill={entry.color} 
                      className="transition-opacity duration-300 outline-none cursor-crosshair"
        ...
        <motion.section variants={itemVariants} className="flex flex-col gap-8 bg-[#050505] border border-white/10 rounded-3xl p-6 md:p-10 shadow-inner">
          ...
          <div className="relative pl-6 md:pl-8 border-l border-white/10 flex flex-col gap-10 mt-4">
            ...
            <div className="relative group">
              <div className="absolute -left-[37px] md:-left-[45px] top-0.5 bg-[#000000] p-1 rounded-full border border-white/10 group-hover:border-blue-500/50 transition-colors">
                <Calendar className="w-4 h-4 text-zinc-400 group-hover:text-blue-400 transition-colors" />
              </div>
              <div className="flex flex-col gap-2">
            ...
            {/* Phase 2 */}
            <div className="relative group">
              <div className="absolute -left-[37px] md:-left-[45px] top-0.5 bg-[#000000] p-1 rounded-full border border-white/10 group-hover:border-red-500/50 transition-colors">
                <Crosshair className="w-4 h-4 text-zinc-400 group-hover:text-red-400 transition-colors" />
              </div>
              <div className="flex flex-col gap-2">
                <div className="flex flex-col sm:flex-row sm:items-baseline gap-2">
            ...
            {/* Phase 3 */}
            <div className="relative group">
              <div className="absolute -left-[37px] md:-left-[45px] top-0.5 bg-[#000000] p-1 rounded-full border border-white/10 group-hover:border-emerald-500/50 transition-colors">
                <TrendingUp className="w-4 h-4 text-zinc-400 group-hover:text-emerald-400 transition-colors" />
              </div>
              <div className="flex flex-col gap-2">
                <div className="flex flex-col sm:flex-row sm:items-baseline gap-2">
            ...
            <div className="bg-[#050505] border border-white/10 hover:border-yellow-500/40 hover:bg-yellow-950/10 transition-all duration-300 rounded-2xl p-6 flex flex-col gap-4 shadow-inner group">
              <div className="flex justify-between items-start">
                <div className="p-2 bg-white/5 border border-white/10 rounded-lg group-hover:bg-yellow-500/10 group-hover:border-yellow-500/30 transition-colors">
                  <Activity className="w-4 h-4 text-zinc-400 group-hover:text-yellow-400 transition-colors" />
                </div>
            ...
            <div className="bg-[#050505] border border-white/10 hover:border-red-500/40 hover:bg-red-950/10 transition-all duration-300 rounded-2xl p-6 flex flex-col gap-4 shadow-inner group">
              <div className="flex justify-between items-start">
                <div className="p-2 bg-white/5 border border-white/10 rounded-lg group-hover:bg-red-500/10 group-hover:border-red-500/30 transition-colors">
                  <Shield className="w-4 h-4 text-zinc-400 group-hover:text-red-400 transition-colors" />
                </div>
